...
export const createValidationSchema = (tTransactions: TransactionsTFunction) =>
  Yup.object().shape({
    type: Yup.string()
      .oneOf(Object.values(TransactionTypeEnum), tTransactions("form.validation.typeInvalid"))
    ...
    currency: Yup.string()
      .oneOf(Object.values(CurrencyEnum), tTransactions("form.validation.currencyInvalid"))
      .required(tTransactions("form.validation.currencyRequired")),
    category: Yup.string()
      .oneOf(Object.values(CategoryEnum), tTransactions("form.validation.categoryInvalid"))
      .required(tTransactions("form.validation.categoryRequired")),
    description: Yup.string().optional(),
    date: Yup.string()
      .test("is-valid-date", tTransactions("form.validation.dateInvalid"), (value) =>
