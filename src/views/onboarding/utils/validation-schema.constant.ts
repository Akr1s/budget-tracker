...
export const createValidationSchema = (tOnboarding: OnboardingTFunction) =>
  Yup.object().shape({
    categories: Yup.array()
      .of(Yup.string().oneOf(Object.values(CategoryEnum), tOnboarding("validation.categories.invalid")))
      .min(1, tOnboarding("validation.categories.minOne")),
    currency: Yup.string()
      .oneOf(Object.values(CurrencyEnum), tOnboarding("validation.currency.invalid"))
      .required(tOnboarding("validation.currency.required")),
    language: Yup.string()
      .oneOf(Object.values(LanguageEnum), tOnboarding("validation.language.invalid"))
      .required(tOnboarding("validation.language.required")),
    primaryIncomeSource: Yup.string()
      .oneOf(Object.values(IncomeSourceEnum), tOnboarding("validation.primaryIncomeSource.invalid"))
    ...
    primarySourceMonthlyAmount: Yup.number()
      ...
      .moreThan(0, tOnboarding("validation.primarySourceMonthlyAmount.positive"))
    ...
    startingDate: Yup.string()
      .test("is-valid-date", tOnboarding("validation.startingDate.invalid"), (value) =>
